...
func (a *App) CronosLandingHandler(w http.ResponseWriter, req *http.Request) {
	cronosTemplate, err := template.ParseFS(templates, "templates/cronos.html")
	if err != nil {
...
func (a *App) PasswordResetLandingHandler(w http.ResponseWriter, req *http.Request) {
	resetTemplate, err := template.ParseFS(templates, "templates/password_reset.html")
	if err != nil {
...
func (a *App) NotFoundHandler(w http.ResponseWriter, req *http.Request) {
	err404Template, err := template.ParseFS(templates, "templates/404.html")
	if err != nil {
		http.Error(w, "Internal Server Error", http.StatusInternalServerError)
		return
	}
...
func (a *App) BadRequestHandler(w http.ResponseWriter, req *http.Request) {
	err400Template, err := template.ParseFS(templates, "templates/400.html")
	if err != nil {
		http.Error(w, "Internal Server Error", http.StatusInternalServerError)
		return
	}
